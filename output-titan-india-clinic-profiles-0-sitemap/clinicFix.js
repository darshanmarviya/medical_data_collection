/************************************************************
 *      PUPPETEER + MONGOOSE SCRAPER EXAMPLE
 *      (Clinic now stores doctorIds instead of doctors)
 ************************************************************/
...
const url =
  "https://www.practo.com/delhi/clinic/unaniherbal-new-friends-colony";
scrapeClinicDetail(url)
  .then(() => process.exit(0))
  .catch((err) => {
